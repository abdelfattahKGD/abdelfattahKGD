...
<table border="0" cellpadding="0" cellspacing="0" width="100%" id="about">
  <tr>
    <td width="60%" valign="top">
      ...
      <p align="justify" style="line-height: 1.6;">
        Engineer by skill, designer by heart. I specialize in bridging the gap between robust embedded systems and elegant UI/UX designs. My focus is on creating high-performance, minimalist software and hardware solutions.
      </p>
      <code>$ status --current "Architecting Real-Time Systems"</code>
    </td>
    <td width="40%" align="right">
      <img src="https://github.com/abdelfattahKGD/abdelfattahKGD/blob/main/v1.gif?raw=true" width="220" style="filter: grayscale(100%); border: 1px solid #000; border-radius: 10px;"/>
    </td>
  </tr>
</table>
